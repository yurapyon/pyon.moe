...
const Img2: Component<{
  ...
  return (
    <a href={url()} target="_self" class={props.class || ""}>
      <img src={preview_url()} />
    </a>
  );
};

const Img3: Component<{
  name: string;
  fileType?: string;
  class?: string;
}> = (props) => {
    ...
    <div class="flex flex-col gap-4">
      ...
      <Year year={2025}>
        <div class="bg-lmn-white shadow-md">
          <div class="px-1.5 py-1">ozone; WIP game, character design</div>
      ...
      <Year year={2023}>
        ...
        <div class="bg-lmn-white shadow-md">
          <div class="px-1.5 py-1">some chibis</div>
        ...
        <div class="bg-lmn-white shadow-md">
          <div class="px-1.5 py-1">nanodan pngtuber</div>
      ...
      <Year year={2017}>
        <div class="bg-lmn-white shadow-md">
          <div class="px-1.5 py-1">
            ...
            album art; front and back cover
          </div>
